...
The Kemler side:
        <ul>
            <li>Gert's father <a href="{{ action('PeopleController@show', [18]) }}">Louis Kemler</a> (3 generations back) came to the US
                ...
                the back of a bakery), and Solomon came to NYC by himself to earn money to bring his family to America. Ida stayed in Russia
...
The Kaplan side:
        <ul><li>Bessie's parents <a href="{{ action('FamilyController@show', [3]) }}">Ida & Barnett Kaplan</a> (four generations back) were  the generation that came here (from <b>Lithuania</b>).
