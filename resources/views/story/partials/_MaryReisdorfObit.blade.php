<h4>Mrs. Mary Reisdorf</h4>


<p>We are pained to announce the death of
    <a href="{{ action('PeopleController@show', [251]) }}">Mrs. Mary Glaser</a>, wife of
    <a href="{{ action('PeopleController@show', [250]) }}">Peter Reisdorf</a>, which occurred at her late home in Strykersville, N.Y., April 20th 1890, at the age of 59 years 11 months, 13 days, of stomach difficulty.
    ...
    to <a href="{{ action('PeopleController@show', [250]) }}">Peter Reisdorf</a>,
    ...
    <a href="{{ action('PeopleController@show', [253]) }}">Mrs. Feist</a> of Buffalo,
    a brother, <a href="{{ action('PeopleController@show', [270]) }}">John Glaser</a> also of Buffalo, a sister, Mrs. Fix of Batavia, and nephew J. Reisdorf of Auburn.  Her remains were interred in the cemetery of St. Cecelia's Church at Sheldon, Rev. Father Voss officiating.  She leaves a husband and 11 children to mourn their sad loss.  </p>
