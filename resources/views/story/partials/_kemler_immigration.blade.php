Gert's father <a href="{{ action('PeopleController@show', [18]) }}">Louis Kemler</a> (3 generations back) came to the US from Kiev, Ukraine
(still part of the Russian empire at
the time) with his father <a href="{{ action('PeopleController@show', [17]) }}">Solomon</a>
...
his family to America. <a href="{{ action('PeopleController@show', [16]) }}">Ida</a>  stayed in Russia with at least one
